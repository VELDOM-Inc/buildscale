...
<html prefix="og: http://ogp.me/ns#" lang="ja">
	...
	<body>
		...
		<div class="t-wrap">
			<!--============================================== header -->
			<?php include($_SERVER['DOCUMENT_ROOT']).'/common/inc/header02.html'; ?>
			<!--============================================== /header -->
			...
			<div class="c-index-visual">
				<div class="c-index-visual__inner">
					<div class="c-index-visual__txt">
						...
						<p class="__detail">資金繰りのリスクを検知する<br>
							予実管理システム</p>
					...
					<ul class="c-index-issues__list">
						<li class="c-index-issues__item">
							<div class="c-index-issues__img">
								<img src="/common/img/index/img_issues05.png" alt="調達した原価がブラックボックスで調達した金額や量が正しいのか分からない" class="__elem lazyload u-w100p">
							</div>
							<p class="c-index-issues__txt">月次決算や予実管理の<br class="u-sm-min">集計作業をエクセルで行い<br class="u-sm-min">時間がかかっている</p>
						</li>
						<li class="c-index-issues__item">
							<div class="c-index-issues__img">
								<img src="/common/img/index/img_issues04.png" alt="工務部や調達部の定量的な評価ができていない" class="__elem lazyload u-w100p">
							</div>
							<p class="c-index-issues__txt">出来高払いを含め<br class="u-sm-min">数ヶ月先の支払予測が<br class="u-sm-min">不透明になっている</p>
						</li>
						<li class="c-index-issues__item">
							<div class="c-index-issues__img">
								<img src="/common/img/index/img_issues06.png" alt="属人的かつ感覚で調達や仕入れをしている" class="__elem lazyload u-w100p">
							</div>
							<p class="c-index-issues__txt">部署や営業所単位の粒度で<br class="u-sm-min">データの見える化が<br class="u-sm-min">出来ていない</p>
						</li>
					</ul>
				</div>
			</section>
				...
				<div class="c-index-inner">
					<div class="c-index-what__box">
						<p class="c-index-what__txt">ビルドスケールは<br>
							<span class="__blue">数ヶ月先の資金繰りのリスクを検知する</span><br>ツールです！</p>
					</div>
				</div>
			</section>
			<!-- /.c-index-what -->
						...
						<li class="c-index-function__item">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">建設業に特化した資金繰りのリスクを検知</span>
								</h3>
								<p class="__txt">建設業ならではの出来高払い含め、資金繰りのリスクを検知してすぐにお知らせします。<br>過去のデータも蓄積できることからこれまでの支払い実績の推移も確認できます。</p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">数ヶ月先の支払予測を見える化</span>
								</h3>
								<p class="__txt">支払いが先行する建設業特有の事情に合わせて<br class="u-sm-min">発注データや請求データなどをベースに数ヶ月先の支払いを予測して見える化します。</p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">実行予算と実績を突合する<br class="u-sm-min">予実分析</span>
								</h3>
								<p class="__txt">原価管理ソフトや会計ソフトなどと連携し見える化します。<br class="u-sm-min">月次決算のための集計作業も不要です。<br><span class="__small">※使用ツールの連携についての詳細はお問い合わせください。</span></p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">注文書作成〜請求書受領まで一気通貫</span>
								</h3>
								<p class="__txt">発注データから請求データまで自動で蓄積されるため<br>リアルタイムで支払予測が可能になります。</p>
							</div>
						</li>
					</ul>
				</div>
			...
			<!--============================================== footer -->
			<?php include($_SERVER['DOCUMENT_ROOT']).'/common/inc/footer02.html'; ?>
			<!--============================================== /footer -->
		</div>
