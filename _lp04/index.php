				...
				<div class="c-index-inner">
					<ul class="c-index-issues__list">
						<li class="c-index-issues__item">
							...
							<p class="c-index-issues__txt">現場担当者の<br class="u-sm-min">人員配置計画・変更が<br class="u-sm-min">煩雑で時間がかかっている</p>
						</li>
						<li class="c-index-issues__item">
							<div class="c-index-issues__img">
								<img src="/common/img/index/img_issues07.png" alt="工種ごとの協力会社の手配状況が分からず工程管理ができていない" class="__elem lazyload u-w100p">
							</div>
							<p class="c-index-issues__txt">工種ごとの協力会社の<br class="u-sm-min">手配状況が分からず<br class="u-sm-min">工程管理ができていない</p>
						</li>
						<li class="c-index-issues__item">
							<div class="c-index-issues__img">
								<img src="/common/img/index/img_issues08.png" alt="現場担当者と協力会社の保有資格が人員配置と一致していない" class="__elem lazyload u-w100p">
							</div>
							<p class="c-index-issues__txt">現場担当者と<br class="u-sm-min">協力会社の保有資格が<br class="u-sm-min">人員配置と一致していない</p>
						</li>
					</ul>
				</div>
			</section>
				...
				<div class="c-index-inner">
					<div class="c-index-what__box">
						<p class="c-index-what__txt">ビルドスケールは<br>
							<span class="__blue">現場の人員配置と協力会社手配を一括管理する</span><br>ツールです！</p>
					</div>
				</div>
			</section>
			<!-- /.c-index-what -->
						...
						<li class="c-index-function__item">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">保有資格と連動し現場担当者の人員配置計画・変更</span>
								</h3>
								<p class="__txt">自社の現場担当者が保有している資格を管理し、資格と連動した現場担当者の人員配置が可能です。一度作成した人員配置の計画もシステム上で何度も変更修正が可能です。</p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
								<img src="/common/img/index/img_function10.jpg" class="__elem lazyload u-w100p" alt="請求書受領サービスや原価管理ソフト、会計ソフトからインポートするだけで自動集計し原価の内訳までを見える化">
							</div>
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									<span class="__number">02</span>
									<span class="__ttl">協力会社の手配も一元管理</span>
								</h3>
								<p class="__txt">どの現場で、どの工種で協力会社を手配しているのか一目でわかるようになります。<br class="u-sm-min">さらに具体的に何をいくらで発注しているかまで情報が紐づいて管理できます。</p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
							...
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									...
									<span class="__ttl">工事受注前から情報共有できる<br class="u-sm-min">工程管理</span>
								</h3>
								<p class="__txt">営業部と工事部で工事受注前から情報共有し、工事を受注できる余裕があるのか、<br class="u-sm-min">協力会社の手配ができるのか工程管理が可能です。山崩しにもご活用いただけます。</p>
							</div>
						</li>
						<li class="c-index-function__item">
							<div class="c-index-function__img">
								<img src="/common/img/index/img_function11.jpg" class="__elem lazyload u-w100p" alt="仕入れ先となる協力会社のデータ化も実現">
							</div>
							<div class="c-index-function__detail">
								<h3 class="e-h3">
									<span class="__number">04</span>
									<span class="__ttl">既存ソフトと連携し工事案件情報を取り込み可能</span>
								</h3>
								<p class="__txt">工事受注前、受注後に関わらず、<br>既存ソフトで登録した工事案件情報をすぐに取り込むことが可能です。<br><span class="__small">※使用ツールの連携についての詳細はお問い合わせください。</span></p>
							</div>
						</li>
					</ul>
				</div>
