...
<html prefix="og: http://ogp.me/ns#" lang="ja">
	<head>
		...
		<meta charset="utf-8">
		<title>送信内容確認画面：BUILD SCALE｜ビルドスケール</title>
		...
		<div class="t-wrap">
			...
			<nav class="c-breadcrumb">
				<ul class="c-breadcrumb__inner">
					...
					<li class="c-breadcrumb__item">お問い合わせ送信内容確認</li>
				</ul>
			</nav>
			<!-- /.c-breadcrumb -->
			...
			<div class="l-contents" id="form">
				<p class="u-mb-m u-al-c _sm-al-l_">ご入力内容を確認いただき、よろしければ「入力内容を送信する」ボタンを、<br>
				...
				<form method="post">
					<table class="m-table _sp-col1_ u-mb-m">
						<tbody class="m-table--body">
							<tr>
								<th>ご相談内容</th>
								<td class="_border_"><?php echo e($form->get('class')); ?></td>
							</tr>
							<tr>
					...
					<div class="u-al-fc">
						<button type="button" class="e-btn-arrow _gray_ _p-30_ _w-l_ _order2_" onclick="window.location='./#contact';">
