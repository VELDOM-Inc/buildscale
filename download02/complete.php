...
<html prefix="og: http://ogp.me/ns#" lang="ja">
	<head>
		...
		<meta charset="utf-8">
		<title>送信完了画面：サービス資料ダウンロード｜BUILD SCALE｜ビルドスケール</title>
		...
		<div class="t-wrap">
			...
			<nav class="c-breadcrumb">
				<ul class="c-breadcrumb__inner">
					...
					<li class="c-breadcrumb__item"><a href="/_service/" class="c-breadcrumb__link">サービス資料ダウンロード</a></li>
					<li class="c-breadcrumb__item">内容送信完了</li>
				</ul>
			</nav>
			<!-- /.c-breadcrumb -->
			...
			<div class="l-contents">
				<h2 class="e-h3 _blue_ u-al-c">サービス資料ダウンロードお申込み<br class="u-sm-max">ありがとうございました</h2>
				<p class="u-al-c u-mb-m _sm-al-l_">サービス資料ダウンロードお申込みを承りました。<br>3営業日以内に担当者よりご連絡いたしますので今しばらくお待ちくださいませ。</p>
