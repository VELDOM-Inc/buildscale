			...
			<div class="l-contents _col2_">
				...
				<div class="c-download-ttl">
					<div class="c-download-ttl__txt">
						<h2 class="c-download-ttl__title">建設業向け<br>注文請書の受領回収から<br>請求書の受領まで<br>一気通貫</h2>
						<p class="c-download-ttl__detail">2024年1月からの<br>改正電子帳簿保存法に対応</p>
					</div>
					<div class="c-download-ttl__img">
						<img src="/common/img/download/img_download03.png" alt="建設業向け 注文請書の受領回収から請求書の受領まで一気通貫" class="lazyload u-w100p">
					</div>
				</div>
				...
				<!-- .l-contents__body -->
					...
					<aside class="l-contents__side">
						<h3 class="e-h3 _blue_ _center_">利用できる機能</h3>
						<ol class="e-list-number _blue-number_">
							<li class="e-list-number__item">
								<h4 class="e-h3 u-fz-20 _sm-fz-18_ u-mb-xxxs">注文書の送付・注文請書の回収受領から請求書受領まで一気通貫</h4>
								<p class="u-fz-16 _sm-fz-15_">注文書の作成送付や注文請書の回収受領、請求書の受領までオンラインで完結できます。</p>
							</li>

							<li class="e-list-number__item">
								<h4 class="e-h3 u-fz-20 _sm-fz-18_ u-mb-xxxs">協力会社の請求書作成業務を削減</h4>
								<p class="u-fz-16 _sm-fz-15_">注文書から請求書の受領を一気通貫で使えることで協力会社の負担を削減し請求書作成業務を簡略化できます。</p>
							</li>
							
							<li class="e-list-number__item">
								<h4 class="e-h3 u-fz-20 _sm-fz-18_ u-mb-xxxs">請求書の社内回覧・査定承認をワンクリック</h4>
								<p class="u-fz-16 _sm-fz-15_">社内外どこにいても請求書の社内回覧ができます。また、注文書と請求書の突合作業を大幅に削減できます。</p>
							</li>
						</ol>
					</aside>
					<!-- .l-contents__side -->
